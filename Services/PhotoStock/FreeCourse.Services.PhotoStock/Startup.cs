    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers(opt => {
                opt.Filters.Add(new AuthorizeFilter());// photo altýndaki tüm controllera a authorize atribute ekleniþ olacak. bu direk controller üzerine koyarakta yapabiliriz.
            });
